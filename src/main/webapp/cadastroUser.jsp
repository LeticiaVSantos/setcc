    ...
    <div class="card" style="width: 60rem;">
        <form>
            ...
            <div class="form-group col-md-5">
                <label>Nome</label>
                <input type="text" name="name" class="form-control"  placeholder="Insira o nome do usuário">
            </div>

            <div class="form-group col-md-5">
                <label>Endereço de email</label>
                <input type="email" name="email" class="form-control" placeholder="Insira o email do usuário">
            </div>
