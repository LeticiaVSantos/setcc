                    ...
                    <tr class="row100">
                            ...
                            <td class="column100 column1" data-column="column1">
                                ...
                                <td class="column100 column1" data-column="column1">
                                    ...
                                    <input class="input-group-sm" type="radio" name="integrantesALT" value="<%=u.getId()%>"> <%=u.getName()%><br/>
                                    <% } %>
                                    <% } %>
                                </td>
                                ...
                                <td class="column100 column1" data-column="column1">
                                    ...
                                    <input class="input-group-sm" type="radio" name="orientadorALT" value="<%=u.getId()%>"> <%=u.getName()%><br/>
                                    <% } %>
                                    <% } %>
                                </td>
