    ...
    <div class="wrap-contact100">
        <form class="contact100-form validate-form">
            ...
            <div class="wrap-input100 validate-input">
                ...
                <input id="aluno" class="input-group-sm" type="radio" name="integrantes" value="<%=u.getId()%>"> <%=u.getName()%><br/>
                <% } %>
                <% } %>
                <span class="focus-input100"></span>
            </div>
            ...
            <div class="wrap-input100 validate-input">
                ...
                <input id="professor" class="input-group-sm" type="radio" name="orientador" value="<%=u.getId()%>"> <%=u.getName()%><br/>
                <% } %>
                <% } %>
                <span class="focus-input100"></span>
            </div>
